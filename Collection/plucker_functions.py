...
# Point from intersection of line and plane
...
# Point from intersection of three planes
...
if __name__ == "__main__":
    ...
    print(" ______________ THIS ______________")
    x = np.array([1,-1,0,1])
    y = np.array([1,1,0,1])
    print("Line defines by x and y is \n(l, l'): \n{}".format(points2line(x, y)))
    ...
    y = np.array([4,3,2,1])
    z = np.array([2,2,2,1])
    print('\nPlane defined by points x, y and z are: \nu: {}'.format(x, y, z, points2plane(x, y, z)))
    ...
    l = points2line(x,y)
    z = np.array([2,2,2,1])
    print('\nPlane defined by line l and point x is: \nu: {}'.format(line_and_point2plane(l, z)))
    ...
    v = np.array([4,3,2,1])
    l = planes2line(u, v)
    print("\nLine defines by the planes u and v is: \n(l, l'): \n{}".format(l))
    ...
    print("\nPoint, x, at intersection betwee line l and plane u \nx: {}".format(x))
    # Test Expected zeros
    ...
    print('\nHomogenous point, x, of intersection of l1 and l2: \nx: {}'.format(lines2point(l1, l2)))
    ...
    print("\nIntersection of three planes u, v, w: \n{}".format(x))
    # Test if x is on all planes
    print('x is on u:', is_point_on_plane(x, u))
    ...
    print('\nDistance between l1 and l2: {}'.format(dist_between_lines(l1, l2)))
    
    
    # Distance from point to plane
    l = np.array([[0,1,0], np.cross([1,0,1], [0,1,0])])
    x = np.array([0,2,4,2])
    print('\nDistance between point x to line l: {}'.format(dist_point2line(x, l)))